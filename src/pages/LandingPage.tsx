...
const LandingPage = () => {
  const features = [
    ...
    },
    {
      ...
      title: "Global Access",
      description:
        "Access your platform from anywhere in the world, anytime.",
      ...
      <section className="container mx-auto px-4 pt-32 pb-20 relative">
        ...
        <div className="text-center max-w-5xl mx-auto relative z-10">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed">
            Streamline team collaboration, track progress in real-time, and boost
      ...
      <section className="container mx-auto px-4 py-32 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Powerful tools designed to help your team collaborate, communicate, and achieve more
          </p>
        </div>
          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${feature.gradient} opacity-20 blur-3xl group-hover:opacity-40 transition-opacity duration-500`} />
        ...
        <div className="relative overflow-hidden rounded-3xl">
          ...
          <CardContent className="relative text-center py-24 px-8 z-10">
            ...
            <p className="text-xl md:text-2xl mb-10 text-blue-100 max-w-2xl mx-auto leading-relaxed">
              Join <span className="font-bold">10,000+</span> teams already using our platform to achieve incredible results
            </p>
