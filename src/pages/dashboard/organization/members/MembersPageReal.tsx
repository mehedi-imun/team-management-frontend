...
export default function MembersPage() {
  ...
  // Show error if no organizationId
  if (!organizationId) {
    return (
          ...
          <CardContent className="py-12">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                You are not associated with any organization. Please contact
                your administrator.
              </p>
            </div>
          </CardContent>
            ...
            <Alert variant="destructive" className="mb-6">
              <AlertDescription>
                {(() => {
                  ...
                  if (
                    errorMessage ===
                    "Forbidden - Requires one of: SuperAdmin, Admin"
                  ) {
                    return "You don't have permission to view organization members. Please contact your organization administrator.";
                  }
